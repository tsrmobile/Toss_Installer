...
public class BuddhistDateFormat extends SimpleDateFormat {

	/*
	 * Copyright 2000-2005 Sun Microsystems, Inc. All Rights Reserved. DO NOT
	...
	private class BuddhistCalendar extends GregorianCalendar {
		...
		/**
		 * Constructs a BuddhistCalendar based on the current time in the given
		...
		/**
		 * Constructs a BuddhistCalendar based on the current time in the
		...
		/**
		 * Add to field a signed amount without changing larger fields. A
		 * negative roll amount means to subtract from field without changing
		 * larger fields.
		 * 
		 * @param field
		 *            the time field.
		...
		// private Map<String, Integer> getDisplayNamesImpl(int field, int
		// style, Locale locale) {
		// ResourceBundle rb = LocaleData.getDateFormatData(locale);
		// String[] eras = rb.getStringArray(getKey(style));
	...
	public BuddhistDateFormat(String pattern) {
		super(pattern);
		// TODO Auto-generated constructor stub
		this.setCalendar(new BuddhistCalendar());
	}
	
	public BuddhistDateFormat() {
		this("dd/MM/yyyy");
	}
}
